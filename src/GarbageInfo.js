  ...
  return (
    <div className="garbageinfo-container">
      ...
      <p className="garbageinfo-p">
        ...
        for text service to receive a text. This model uses about 300 images and may not capture all forms
        of garbage trucks and bins. The more quality image training material that is used, the better the machine learning
        process can determine a broader range of garbage pickups.
      </p>
      <p className="garbageinfo-p">You can view the video demo, and tutorial on a quick implementation of the app here:
      <a
          className="youtube-link"
